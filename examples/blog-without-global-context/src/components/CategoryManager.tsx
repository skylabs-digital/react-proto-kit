...
export function CategoryManager({ onCategoryChange }: CategoryManagerProps) {
  ...
  const { data: categories = [], loading, error, refetch: refetchCategories } = categoriesApi.useList();
  ...
  const createDefaultCategories = async () => {
    const defaultCategories = [
      { name: 'General', slug: 'general', description: 'General blog posts and announcements' },
      { name: 'Technology', slug: 'technology', description: 'Technology and programming related posts' },
